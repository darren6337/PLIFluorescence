...
def listImages(imageDirectory, extension = '.tif'):
    """ Returns a list of images within imageDirectory that have the
...
def experimentDirectory(rootDirectory, primeDirectory = 'images', subDirectory = 'calibration'):
    """ Returns imageDir, a list with a primary image directory in 
    ...
    if rootDirectory != primeDirectory and primeDirectory != '':
        """ If rootDirectory and primeDirectory are not the same,
        ...
        """ Creates imageDir, the directory within the rootDirectory 
            that contains the name listed in primeDirectory. 
            """
            
    elif rootDirectory == primeDirectory or primeDirectory == '':
        """ If rootDirectory and primeDirectory are the same, or 
            primeDirectory is specified as an empty string, the 
            images are located within the rootDirectory itself. 
            """
    ...
    """ Appends a sublist of folders to the second entry in imageDir, 
